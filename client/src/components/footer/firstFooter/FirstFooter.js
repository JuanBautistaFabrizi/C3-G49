        ...
        <div className="firstFooter">
                <div className="logosFooter">
                    ...
                    <div className="followUs">
                        ...
                        <a href="https://www.instagram.com/fravegaonline/" target="_blank">
                            ...
                            35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 
                            26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 
                            11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 
                            29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 
                            102.7-9 132.1z"></path>
                            </svg>    
                        </a>
                        ...
                        <a href="https://www.youtube.com/user/fravegaonline" target="_blank">
                            ...
                            64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 
                            132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 
                            448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 
                            11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"></path>
                            </svg>
                        </a>
                        ...
                        <a href="https://twitter.com/fravegaonline" target="_blank">    
                            ...
                            94.213-16.568 130.274-44.832-46.132-.975-84.792-31.188-98.112-72.772 6.498.974 12.995 1.624 
                            19.818 1.624 9.421 0 18.843-1.3 27.614-3.573-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 
                            ...
                            46.456-13.32 66.599-25.34-7.798 24.366-24.366 44.833-46.132 57.827 21.117-2.273 
                            41.584-8.122 60.426-16.243-14.292 20.791-32.161 39.308-52.628 54.253z"/></svg>
                        </a>
                        ...
                        <a href="https://www.linkedin.com/company/fravega-saciei/" target="_blank">
                            ...
                            37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 
                            61.9 111.28 142.3V448z"/>
                            </svg>
                        </a>
                    </div>
                </div>

                <div className="customerAtention">
                    <div className="footerHeadline">
                        <h3>Atención al cliente:</h3>
                        <a href="tel:0810 999 3728">0810 999 3728</a>
                    </div>
                    <p>LU-VI de 09:00 a 18:00</p>
                    <p>SA de 9:00 a 13:00</p>
                </div>

                <div className="creditCollection">
                    <div className="footerHeadline">
                        <h3>Cobranza de créditos:</h3>
                        <a href="tel:0810 222 8368">0810 222 8368</a>
                    </div>
                    <p>LU-VI de 08:00 a 19:45</p>
                </div>

                <div className="telephoneSales">
                    <div className="footerHeadline">
                        <h3>Venta telefónica:</h3>
                        <a href="tel:0810 333 8700">0810 333 8700</a>
                    </div>
                    <p>LU-VI de 08:00 a 20:00</p>
                    <p>SA-DO-Feriados 9:00 a 21:00</p>
                </div>
                
                <div className="corporateSales">
                    <h3>Servicios a empresas:</h3>
                    <a href="https://www.fravega.com/corporativo">Ventas corporativas</a>
                </div>

                <div className="empyFooter">
                <h3>Servicios a empresas:</h3>
                    <a href="https://www.fravega.com/corporativo">Ventas corporativas</a>
                </div>
